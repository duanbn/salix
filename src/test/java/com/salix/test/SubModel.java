...
public class SubModel extends BaseTest implements Serializable, Comparable<SubModel> {
	...
	public Calendar[] cals = new Calendar[] { Calendar.getInstance(), Calendar.getInstance(), Calendar.getInstance(),
...
//	private InnerStaticModel innerStaticModel = new InnerStaticModel();
	...
	public SubModel() {
		...
		InnerPubStaticModel innerPubStaticModel = new InnerPubStaticModel();
		map.put("innerPubStaticModel", innerPubStaticModel);
	}

	public static class InnerPubStaticModel extends BaseTest implements Serializable {
		public boolean bool = true;
		public boolean[] bools = new boolean[] { true, false, true };
		public Boolean obool = new Boolean(false);
		public Boolean[] obools = new Boolean[] { new Boolean(true), new Boolean(false) };
	...
	private static class InnerStaticModel extends BaseTest implements Serializable {
		public boolean bool = true;
		public boolean[] bools = new boolean[] { true, false, true };
		public Boolean obool = new Boolean(false);
		public Boolean[] obools = new Boolean[] { new Boolean(true), new Boolean(false) };
